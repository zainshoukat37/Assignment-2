...
def plot_worldbank_data(extracted_data, title, xlabel, ylabel):
    ...
    extracted_data.T.plot(kind='line', marker='o', ax=ax)
...
def main():
    ...
    if df is not None:
        ...
        if extracted_data is not None:
            ...
            plot_worldbank_data(extracted_data, 'Annual GDP Growth% of Countries (2005 to 2021, 4-Year Intervals)', 'Years', 'Values')
